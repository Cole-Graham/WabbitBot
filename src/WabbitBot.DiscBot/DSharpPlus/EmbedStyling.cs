...
public static class EmbedStyling
{
    ...
    /// </summary>
    public static DiscordColor GetSuccessColor() => new DiscordColor(76, 175, 80); // Green

    /// <summary>
    /// Gets the warning color for cautionary messages
    /// </summary>
    public static DiscordColor GetWarningColor() => new DiscordColor(255, 152, 0); // Orange

    /// <summary>
    /// Gets the error color for failures and errors
    /// </summary>
    public static DiscordColor GetErrorColor() => new DiscordColor(244, 67, 54); // Red

    /// <summary>
    /// Gets the info color for informational messages
    /// </summary>
    public static DiscordColor GetInfoColor() => new DiscordColor(33, 150, 243); // Light Blue

    /// <summary>
    /// Creates a standard embed author
    /// </summary>
    public static DiscordEmbedBuilder.EmbedAuthor CreateStandardAuthor(string name, string? iconUrl = null, string? url = null)
    {
    ...
    /// </summary>
    public static DiscordColor GetMatchStatusColor(MatchStatus status) => status switch
    {
    ...
    /// </summary>
    public static string GetScrimmageStatusDisplayName(ScrimmageStatus status) => status switch
    {
        ScrimmageStatus.Created => "⏳ Created",
