...
namespace WabbitBot.Core.Common.Models.Common
{
    public partial class MashinaUserCore : IMashinaUserCore
    {
        ...
        {
            var userResult = await CoreService.MashinaUsers.GetByIdAsync(mashinaUserId, WabbitBot.Common.Data.Interfaces.DatabaseComponent.Repository);
            ...
            var updateRepo = await CoreService.MashinaUsers.UpdateAsync(user, WabbitBot.Common.Data.Interfaces.DatabaseComponent.Repository);
            var updateCache = await CoreService.MashinaUsers.UpdateAsync(user, WabbitBot.Common.Data.Interfaces.DatabaseComponent.Cache);
        ...
        public async Task<Result> SetActiveAsync(Guid mashinaUserId, bool isActive)
        {
            ...
            user.LastActive = DateTime.UtcNow;
            var update = await CoreService.MashinaUsers.UpdateAsync(user, WabbitBot.Common.Data.Interfaces.DatabaseComponent.Repository);
